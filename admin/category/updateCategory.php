                ...
                <div class="container pt-5 mt-5">
                    <form action="index.php?act=updatedm" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?=$categorys_id?>" id="exampleFormControlInput1" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Tên danh mục</label>
                            <input type="text" name="name" class="form-control" id="exampleFormControlInput1" value="<?=$name?>">
                        </div>
                        <div class="mb-3 d-flex justify-content-center">
                            <input type="hidden" name="iddm" class="form-control" id="exampleFormControlInput1" value="<?=$categorys_id?>">
